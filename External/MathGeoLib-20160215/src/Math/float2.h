...
#ifdef MATH_OGRE_INTEROP
	float2(const Ogre::float2 &other):x(other.x), y(other.y) {}
	operator Ogre::float2() const { return Ogre::float2(x, y); }
#endif
#ifdef MATH_QT_INTEROP
...
#endif
#ifdef MATH_URHO3D_INTEROP
	float2(const Urho3D::float2 &other) : x(other.x_), y(other.y_) {}
	operator Urho3D::float2() const { return Urho3D::float2(x, y); }
#endif
};
