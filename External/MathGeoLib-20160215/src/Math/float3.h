...
public:
	...
	static MUST_USE_RESULT float3 FromSphericalCoordinates(const float3 &spherical) {
#pragma warning( push )
#pragma warning( disable : 6031 )
    return FromSphericalCoordinates(spherical.x, spherical.y, spherical.z);
#pragma warning( pop )
  }
...
#ifdef MATH_ENABLE_STL_SUPPORT
	static MUST_USE_RESULT float3 FromString(const std::string &str) {
#pragma warning( push )
#pragma warning( disable : 6031 )
...
#pragma warning( pop )
	...
	static inline float3 RandomGeneral(LCG &lcg, float minElem, float maxElem) {
#pragma warning( push )
#pragma warning( disable : 6031 )
    return RandomBox(lcg, minElem, maxElem);
#pragma warning( pop )
  }
...
#ifdef MATH_OGRE_INTEROP
	float3(const Ogre::float3 &other):x(other.x), y(other.y), z(other.z) {}
	operator Ogre::float3() const { return Ogre::float3(x, y, z); }
#endif
#ifdef MATH_QT_INTEROP
...
#endif
#ifdef MATH_URHO3D_INTEROP
	float3(const Urho3D::float3 &other) : x(other.x_), y(other.y_), z(other.z_) {}
	operator Urho3D::float3() const { return Urho3D::float3(x, y, z); }
#endif
#ifdef MATH_IRRKLANG_INTEROP
