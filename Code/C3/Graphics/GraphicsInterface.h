...
public:
  ...
  virtual void CreateIndexBuffer(IndexBufferHandle handle, const MemoryBlock* mem, u16 flags) = 0;
  ...
  virtual void CreateVertexBuffer(VertexBufferHandle handle, const MemoryBlock* mem, VertexDeclHandle decl_handle, u16 flags) = 0;
  virtual void DestroyVertexBuffer(VertexBufferHandle handle) = 0;
  virtual void CreateDynamicIndexBuffer(IndexBufferHandle handle, u32 size, u16 flags) = 0;
  virtual void UpdateDynamicIndexBuffer(IndexBufferHandle handle, u32 offset, u32 size, const MemoryBlock* mem) = 0;
  virtual void CreateDynamicVertexBuffer(VertexBufferHandle handle, u32 size, u16 flags) = 0;
  virtual void UpdateDynamicVertexBuffer(VertexBufferHandle handle, u32 offset, u32 size, const MemoryBlock* mem) = 0;
  virtual void CreateShader(ShaderHandle handle, const MemoryBlock* mem) = 0;
  ...
  virtual void CreateTexture(TextureHandle handle, const MemoryBlock* mem, u32 flags, u8 skip) = 0;
  virtual void UpdateTextureBegin(TextureHandle handle, u8 side, u8 mip) = 0;
  virtual void UpdateTexture(TextureHandle handle, u8 side, u8 mip, const TextureRect& rect, u16 z, u16 depth, u16 pitch, const MemoryBlock* mem) = 0;
