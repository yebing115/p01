...
public:
	...
	static FORCE_INLINE MUST_USE_RESULT Quat Lerp(const Quat &source, const Quat &target, float t) {
#pragma warning( push )
...
#pragma warning( pop )
	...
	static FORCE_INLINE MUST_USE_RESULT Quat Slerp(const Quat &source, const Quat &target, float t) {
#pragma warning( push )
#pragma warning( disable : 6031 )
    return source.Slerp(target, t);
#pragma warning( pop )
  }
...
#ifdef MATH_ENABLE_STL_SUPPORT
	static MUST_USE_RESULT Quat FromString(const std::string &str) {
#pragma warning( push )
#pragma warning( disable : 6031 )
...
FORCE_INLINE Quat Lerp(const Quat &a, const Quat &b, float t) {
#pragma warning( push )
#pragma warning( disable : 6031 )
  return a.Lerp(b, t);
#pragma warning( pop )
}
FORCE_INLINE Quat Slerp(const Quat &a, const Quat &b, float t) {
#pragma warning( push )
#pragma warning( disable : 6031 )
  return a.Slerp(b, t);
#pragma warning( pop )
